        ...
        <div  style={{overflow:'hidden'}}>
            <footer className=" bg-white py-4 mt-auto row row-cols-1 row-cols-sm-2 row-cols-md-5 ">
                ...
                <div className="col mb-3 socialFooter" style={{textAlign:'left',marginLeft:"80px"}} >
                    ...
                    <a className="text-black" href="https://telegram.equilibriacc.com">
                        <img   src={telegramLogo} style={{width:"30px"}}/>
                        
                    </a>
                    <a className="text-black" href="https://discord.equilibriacc.com">
                ...
                <div className="col mb-3" style={{textAlign:'left',marginLeft:"20px"}} >
                    ...
                    <ul className="nav flex-column">
                        <li className="nav-item mb-2"><a href="https://telegram.equilibriacc.com" className="nav-link p-0 text-muted">NEW EquilibriaCC TG Channel</a></li>
                        <li className="nav-item mb-2"><a href="https://discord.equilibriacc.com" className="nav-link p-0 text-muted">NEW EquilibriaCC Discord Channel</a></li>
